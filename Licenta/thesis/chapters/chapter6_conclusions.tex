...
transformation module, a browser-based editor that requires no
...
The current implementation supports only scalar variables (integers, reals,
strings).  Array and record types are not implemented; programs that require
...
built-in operations --- without touching any backend code.  Introducing
this IR would, however, require a substantial refactoring of the existing
interpreter, transpiler, and static-analysis code.
