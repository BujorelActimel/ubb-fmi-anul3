...
The ability to step \emph{backwards} through execution history --- so-called
\textit{omniscient} or \textit{reversible} debugging \cite{lewis2003omniscient,reversible-debugging}
--- extends this further by letting the developer inspect state at any previous
point without restarting the program.  Pseudo++'s snapshot architecture
(Section~\ref{subsec:pipeline}) provides the foundation for this capability
